-- Script completo para atualizar o modelo de agendamentos
...
-- Adicionar o trigger para usar a função de enriquecimento (opcional)
-- DROP TRIGGER IF EXISTS trigger_enriquecer_agendamento ON agendamentos;
-- CREATE TRIGGER trigger_enriquecer_agendamento
--     BEFORE INSERT OR UPDATE ON agendamentos
--     FOR EACH ROW
--     EXECUTE FUNCTION proc_agendamento_enriquecer_dados();

-- Teste para verificar se a view funciona
