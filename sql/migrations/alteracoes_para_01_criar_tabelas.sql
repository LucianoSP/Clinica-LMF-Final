-- ADICIONE ESTE TRECHO LOGO APÓS OS ÍNDICES DA TABELA AGENDAMENTOS
-- (aproximadamente na linha 438 do arquivo sql/01_criar_tabelas.sql)
...
-- REMOVA TAMBÉM AS FUNÇÕES DUPLICADAS NO FINAL DO ARQUIVO 01_criar_tabelas.sql
-- (aproximadamente linhas 1035-1110) 